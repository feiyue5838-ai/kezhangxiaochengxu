...
const D = regionData.districtsShort;
  ...
  '北京': {'北京': ['东城区','西城区','朝阳区','丰台区','石景山区','海淀区','门头沟区','房山区','通州区','顺义区','昌平区','大兴区','怀柔区','平谷区','密云区','延庆区']},
  ...
  '河北': {
    ...
    '唐山': ['路南区','路北区','古冶区','开平区','丰南区','丰润区','曹妃甸区','滦州市','滦南县','乐亭县','迁西县','玉田县','遵化市','迁安市'],
  ...
  '内蒙古': {
    ...
    '鄂尔多斯': ['康巴什区','东胜区','达拉特旗','准格尔旗','鄂托克前旗','鄂托克旗','杭锦旗','乌审旗','伊金霍洛旗'],
    ...
    '锡林郭勒盟': ['锡林浩特市','阿巴嘎旗','苏尼特左旗','苏尼特右旗','东乌珠穆沁旗','西乌珠穆沁旗','太仆寺旗','镶黄旗','正镶白旗','正蓝旗','多伦县'],
  ...
  '吉林': {
    '长春': ['南关区','宽城区','朝阳区','二道区','绿园区','双阳区','九台区','农安县','公主岭市','榆树市','德惠市'],
  ...
  '黑龙江': {
    ...
    '大兴安岭': ['漠河市','呼玛县','塔河县','加格达奇区','松岭区','新林区','呼中区'],
  },
  '上海': {'上海': ['黄浦区','徐汇区','长宁区','静安区','普陀区','虹口区','杨浦区','闵行区','宝山区','嘉定区','浦东新区','金山区','松江区','青浦区','奉贤区','崇明区']},
  '江苏': {
  ...
  '浙江': {
    '杭州': ['上城区','下城区','拱墅区','江干区','西湖区','滨江区','萧山区','余杭区','临平区','钱塘区','富阳区','临安区','桐庐县','淳安县','建德市'],
  ...
  '安徽': {
    ...
    '芜湖': ['镜湖区','弋江区','鸠江区','三山区','繁昌区','南陵县','无为市'],
  ...
  '福建': {
    ...
    '宁德': ['蕉城区','霞浦县','古田县','屏南县','寿宁县','柘荣县','福安市','福鼎市'],
  },
  '江西': {
  ...
  '河南': {
    '郑州': ['中原区','二七区','管城回族区','金水区','惠济区','上街区','巩义市','荥阳市','新密市','新郑市','登封市','中牟县'],
    '开封': ['龙亭区','顺河回族区','鼓楼区','禹王台区','祥符区','杞县','通许县','尉氏县','兰考县'],
    '洛阳': ['老城区','西工区','瀍河回族区','涧西区','吉利区','洛龙区','偃师区','孟津区','新安县','栾川县','嵩县','汝阳县','宜阳县','洛宁县','伊川县'],
    ...
    '周口': ['川汇区','淮阳区','扶沟县','西华县','商水县','沈丘县','太康县','鹿邑县','项城市'],
    '驻马店': ['驿城区','西平县','上蔡县','平舆县','正阳县','确山县','泌阳县','汝南县','遂平县','新蔡县'],
    '济源': ['沁园街道','济水街道','北海街道','天坛街道','玉泉街道','克井镇','五龙口镇','梨林镇','轵城镇','承留镇','大峪镇','邵原镇','坡头镇','下冶镇'],
  },
  '湖北': {
    ...
    '仙桃': ['干河街道','龙华山街道','沙嘴街道','郑场镇','毛嘴镇','剅河镇','三伏潭镇','胡场镇','长埫口镇','彭场镇','沙湖镇','杨林尾镇','沔城镇','郭河镇','张沟镇','通海口镇','陈场镇'],
    '潜江': ['园林街道','杨市街道','周矶街道','广华街道','泰丰街道','高场街道','竹根滩镇','渔洋镇','王场镇','高石碑镇','熊口镇','老新镇','浩口镇','积玉口镇','张金镇','龙湾镇'],
    '天门': ['竟陵街道','天门新城','岳口街道','候口街道','多宝镇','拖市镇','张港镇','蒋场镇','汪场镇','渔薪镇','黄潭镇','横林镇','彭市镇','麻洋镇','多祥镇','干驿镇','马湾镇','小板镇','九真镇','皂市镇','石家河镇','佛子山镇'],
    '神农架': ['松柏镇','阳日镇','红坪镇','木鱼镇','新华镇','大九湖镇','宋洛乡'],
  },
  '湖南': {
    ...
    '永州': ['零陵区','冷水滩区','祁阳市','东安县','双牌县','道县','江永县','宁远县','蓝山县','新田县','江华瑶族自治县'],
  ...
  '广东': {
    ...
    '东莞': ['莞城街道','南城街道','东城街道','万江街道','石碣镇','石龙镇','茶山镇','石排镇','企石镇','横沥镇','桥头镇','谢岗镇','东坑镇','常平镇','寮步镇','大朗镇','麻涌镇','中堂镇','高埗镇','沙田镇','洪梅镇','道滘镇','厚街镇','虎门镇','长安镇'],
    '中山': ['石岐街道','东区街道','中山港街道','西区街道','南区街道','五桂山街道','小榄镇','横栏镇','古镇镇','东升镇','港口镇','沙溪镇','大涌镇','黄圃镇','南头镇','东凤镇','阜沙镇','三角镇','民众镇','南朗镇','三乡镇','板芙镇','神湾镇','坦洲镇'],
    '潮州': ['湘桥区','潮安区','饶平县'],
  ...
  '广西': {
    ...
    '百色': ['右江区','田阳区','平果市','德保县','那坡县','凌云县','乐业县','田林县','西林县','隆林各族自治县','靖西市'],
  ...
  '海南': {
    ...
    '三亚': ['海棠区','吉阳区','天涯区','崖州区'],
    '三沙': ['西沙群岛','南沙群岛','中沙群岛'],
    '儋州': ['那大镇','和庆镇','南丰镇','大成镇','雅星镇','兰洋镇','光村镇','木棠镇','海头镇','峨蔓镇','王五镇','白马井镇','中和镇','排浦镇','东成镇','新州镇'],
  },
  '重庆': {'重庆': ['渝中区','万州区','涪陵区','渝北区','巴南区','黔江区','长寿区','江津区','合川区','永川区','南川区','璧山区','大足区','铜梁区','潼南区','荣昌区','开州区','梁平区','武隆区','城口县','丰都县','垫江县','忠县','云阳县','奉节县','巫山县','巫溪县','石柱土家族自治县','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县']},
  '贵州': {
    '贵阳': ['云岩区','南明区','花溪区','乌当区','白云区','观山湖区','开阳县','息烽县','修文县','清镇市'],
    '六盘水': ['钟山区','水城区','六枝特区','盘州市'],
    '遵义': ['红花岗区','汇川区','播州区','桐梓县','绥阳县','正安县','道真仡佬族苗族自治县','务川仡佬族苗族自治县','凤冈县','湄潭县','余庆县','习水县','赤水市','仁怀市'],
    '安顺': ['西秀区','平坝区','普定县','镇宁布依族苗族自治县','关岭布依族苗族自治县','紫云苗族布依族自治县'],
    '毕节': ['七星关区','大方县','黔西市','金沙县','织金县','纳雍县','威宁彝族回族苗族自治县','赫章县'],
  ...
  '云南': {
    ...
    '玉溪': ['红塔区','江川区','澄江市','通海县','华宁县','易门县','峨山彝族自治县','新平彝族傣族自治县','元江哈尼族彝族傣族自治县'],
    ...
    '红河': ['个旧市','开远市','蒙自市','弥勒市','屏边苗族自治县','建水县','石屏县','泸西县','元阳县','红河县','绿春县','河口瑶族自治县','金平苗族瑶族傣族自治县'],
  ...
  '西藏': {
    ...
    '日喀则': ['桑珠孜区','南木林县','江孜县','定日县','萨迦县','拉孜县','谢通门县','白朗县','仁布县','康马县','定结县','仲巴县','亚东县','吉隆县','昂仁县','萨嘎县','岗巴县'],
    '昌都': ['卡若区','江达县','贡觉县','类乌齐县','丁青县','察雅县','八宿县','左贡县','芒康县','洛隆县','边坝县'],
    '林芝': ['巴宜区','工布江达县','米林县','墨脱县','波密县','察隅县','朗县'],
    '山南': ['乃东区','扎囊县','贡嘎县','桑日县','琼结县','曲松县','措美县','洛扎县','加查县','错那市','浪卡子县'],
  ...
  '陕西': {
    ...
    '咸阳': ['秦都区','渭城区','杨陵区','三原县','泾阳县','乾县','礼泉县','永寿县','长武县','旬邑县','淳化县','武功县','兴平市','彬州市'],
    '渭南': ['临渭区','华州区','潼关县','大荔县','合阳县','澄城县','蒲城县','白水县','富平县','韩城市','华阴市'],
    '延安': ['宝塔区','安塞区','延长县','延川县','志丹县','吴起县','甘泉县','富县','洛川县','宜川县','黄龙县','黄陵县'],
  ...
  '青海': {
    ...
    '海北': ['海晏县','祁连县','刚察县'],
    '黄南': ['同仁市','尖扎县','河南蒙古族自治县','泽库县'],
    '海南': ['共和县','同德县','贵德县','兴海县','贵南县'],
    '果洛': ['玛沁县','班玛县','甘德县','达日县','久治县','玛曲县'],
    '玉树': ['玉树市','杂多县','称多县','治多县','囊谦县','曲麻莱县'],
    '海西': ['德令哈市','格尔木市','茫崖市','乌兰县','都兰县','天峻县'],
  },
  '宁夏': {
  ...
  '新疆': {
    ...
    '阿克苏': ['阿克苏市','温宿县','库车市','沙雅县','新和县','拜城县','乌什县','阿瓦提县','柯坪县'],
    '喀什': ['喀什市','疏附县','疏勒县','英吉沙县','泽普县','莎车县','叶城县','麦盖提县','岳普湖县','伽师县','巴楚县','塔什库尔干塔吉克自治县'],
    '和田': ['和田市','和田县','墨玉县','皮山县','洛浦县','策勒县','于田县','民丰县'],
    '伊犁': ['伊宁市','奎屯市','霍尔果斯市','伊宁县','霍城县','察布查尔锡伯自治县','巩留县','新源县','昭苏县','特克斯县','尼勒克县'],
    '塔城': ['塔城市','乌苏市','额敏县','沙湾市','托里县','裕民县','和静县','和布克赛尔蒙古自治县'],
    '阿勒泰': ['阿勒泰市','布尔津县','富蕴县','福海县','哈巴河县','青河县','吉木乃县'],
  },
  '台湾': {
    '台北市': ['中正区','大同区','中山区','松山区','大安区','信义区','士林区','北投区','内湖区','南港区','文山区','万华区'],
    '新北市': ['板桥区','三重区','中和区','永和区','土城区','树林区','莺歌区','三峡区','淡水区','汐止区','新店区','五股区','芦洲区','林口区','八德区'],
    '桃园市': ['桃园区','中坜区','平镇区','杨梅区','龙潭区','龟山区','大溪区','大园区','芦竹区','观音区','新屋区'],
    '台中市': ['中区','东区','南区','西区','北区','北屯区','西屯区','南屯区','太平区','大里区','雾峰区','丰原区','后里区','大甲区','清水区','沙鹿区','梧栖区','龙井区'],
    '台南市': ['中西区','东区','南区','北区','安平区','安南区','永康区','新营区'],
    '高雄市': ['楠梓区','左营区','鼓山区','三民区','苓雅区','前镇区','小港区','凤山区','林园区','大寮区','仁武区','冈山区','桥头区','燕巢区'],
  ...
  '四川': {
    ...
    '绵阳': ['涪城区','游仙区','安州区','三台县','盐亭县','梓潼县','平武县','江油市'],
    ...
    '资阳': ['雁江区','安岳县','乐至县'],
    '阿坝': ['马尔康市','汶川县','理县','茂县','松潘县','九寨沟县','阿坝县','若尔盖县','红原县','壤塘县','小金县','黑水县','金川县'],
    '甘孜': ['康定市','泸定县','丹巴县','九龙县','雅江县','道孚县','理塘县','巴塘县','乡城县','稻城县','得荣县','甘孜县','新龙县','德格县','白玉县','石渠县','色达县','炉霍县'],
    '凉山': ['西昌市','德昌县','会理县','会东县','宁南县','普格县','布拖县','金阳县','昭觉县','喜德县','冕宁县','越西县','甘洛县','美姑县','雷波县','木里藏族自治县'],
  },
};
