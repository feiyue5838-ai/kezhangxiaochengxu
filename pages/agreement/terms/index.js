...
<p>用户在使用蓉城企服小程序（以下简称"我们"）提供的服务前，应仔细阅读本协议的全部内容。如您不同意本协议的任何内容，请勿注册或使用本服务。您的注册或使用行为即视为您已阅读并同意本协议的全部内容。</p>
<p><strong>二、服务内容</strong></p>
<p>我们提供的服务包括：电子印章在线办理、报纸公告刊登、证件办理咨询、订单管理等，具体以小程序实际功能为准。我们有权根据业务发展调整服务内容。</p>
...
<p>退款政策请参照具体订单页面的说明。一般情况下，服务已开始执行后不支持退款。如有质量问题，请联系客服协商处理。</p>
<p><strong>六、知识产权</strong></p>
<p>小程序内的所有内容（包括但不限于文字、图片、标识、界面设计等）的知识产权归我们所有，未经书面授权，不得进行任何形式的复制、修改或传播。</p>
<p><strong>七、免责声明</strong></p>
<p>因不可抗力（包括但不限于自然灾害、政策变更、网络故障等）导致服务无法正常提供的，我们不承担责任。因用户自身原因导致的损失，由用户自行承担。</p>
<p><strong>八、协议修改</strong></p>
<p>我们有权随时修改本协议，修改后会在小程序显著位置公告。修改后的协议自公告之日起生效。继续使用服务即视为接受修改后的协议。</p>
<p><strong>九、争议解决</strong></p>
<p>本协议的解释和执行均适用中华人民共和国法律。如双方发生争议，应友好协商解决；协商不成的，提交成都市有管辖权的人民法院诉讼解决。</p>
<p><strong>十、联系方式</strong></p>
<p>客服热线：400-888-6666（工作日 9:00-18:00）</p>`;
