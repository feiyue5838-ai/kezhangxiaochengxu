...
module.exports = {
  ...
  list: [
    ...
    { id: 2,  name: '个人证件',   iconSvg: '/assets/icons/icon-cat-personal.svg', bgColor: '#5B6FE8',  route: '/pages/newspaper/personal-docs/index' },
    ...
    { id: 6,  name: '公告声明',    iconSvg: '/assets/icons/icon-cat-announcement.svg', bgColor: '#5B6FE8',  route: '/pages/newspaper/announcement/index' },
    ...
    { id: 11, name: '环评公示',    iconSvg: '/assets/icons/icon-cat-env.svg', bgColor: '#5B6FE8',  route: '/pages/newspaper/env-assessment/index' },
    { id: 12, name: '拍卖公告',   iconSvg: '/assets/icons/icon-cat-auction.svg', bgColor: '#5B6FE8',  route: '/pages/newspaper/auction/index' },
