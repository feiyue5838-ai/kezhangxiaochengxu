  ...
  categories: [
    {
      ...
      docs: [
        ...
        { name: '二级注册消防工程师', icon: '??' },
        { name: '消防设施操作员', icon: '??' },
        { name: '一级建造师执业资格证书', icon: '???' },
        { name: '二级建造师执业资格证书', icon: '???' },
        { name: '一级造价工程师', icon: '???' },
        { name: '二级造价工程师', icon: '???' },
        { name: '一级注册建筑师', icon: '???' },
        { name: '二级注册建筑师', icon: '???' },
        ...
        { name: '心理咨询师', icon: '??' },
        { name: '公路检测员证', icon: '???' },
        { name: '公路水运工程试验检测师', icon: '???' },
        { name: '水运工程监理工程师', icon: '???' },
        { name: '水利工程质量检测员', icon: '???' },
        { name: '水利造价工程师', icon: '???' },
        { name: '水利水电工程注册土木工程师', icon: '???' },
        { name: '注册设备监理师', icon: '??' },
        { name: '注册验船师', icon: '??' },
        { name: '注册计量师', icon: '??' },
        { name: '标准化工程师', icon: '??' },
