/**
 * 中国省市区数据 - 2024年最新行政区划
 * 数据来源：中华人民共和国行政区划代码（GB/T 2260）
 */
module.exports = {
  // 省级行政区（34个：23省+5自治区+4直辖市+2特别行政区）
  provinces: [
    '全部', '北京市', '天津市', '河北省', '山西省', '内蒙古自治区',
  ...
  cities: {
    ...
    '香港特别行政区': ['全部', '中西区', '东区', '南区', '湾仔区', '九龙城区', '观塘区', '深水埗区', '黄大仙区', '油尖旺区', '离岛区', '葵青区', '北区', '西贡区', '沙田区', '大埔区', '荃湾区', '屯门区', '元朗区'],
    '澳门特别行政区': ['全部', '澳门半岛', '氹仔', '路环'],
    '台湾省': ['全部', '台北市', '新北市', '桃园市', '台中市', '台南市', '高雄市', '基隆市', '新竹市', '嘉义市', '新竹县', '苗栗县', '彰化县', '南投县', '云林县', '嘉义县', '屏东县', '宜兰县', '花莲县', '台东县', '澎湖县', '金门县', '连江县']
  }
};
