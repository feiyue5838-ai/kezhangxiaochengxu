// 完整省市区数据（公开行政区域）
// 数据格式：{ province: [city, city, ...], province: [...] }
// 为压缩体积，每个城市带其下辖区县数组
module.exports = {
  ...
  '河北': {
    ...
    '唐山': ['路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '曹妃甸区', '滦县', '滦南县', '乐亭县', '迁西县', '玉田县', '遵化市', '迁安市'],
  ...
  '山西': {
    ...
    '大同': ['城区', '矿区', '南郊区', '新荣区', '阳高县', '天镇县', '广灵县', '灵丘县', '浑源县', '左云县', '云州区'],
    '阳泉': ['城区', '矿区', '郊区', '平定县', '盂县'],
  ...
  '黑龙江': {
    ...
    '鸡西': ['鸡冠区', '恒山区', '滴道区', '梨树区', '麻山区', '鸡东县', '虎林市', '密山市'],
  ...
  '浙江': {
    ...
    '宁波': ['海曙区', '江北区', '北仑区', '镇海区', '鄞州区', '象山县', '宁海县', '余姚市', '慈溪市', '奉化区'],
  ...
  '福建': {
    '福州': ['鼓楼区', '台江区', '仓山区', '马尾区', '晋安区', '长乐区', '闽侯县', '连江县', '罗源县', '闽清县', '永泰县', '福清市', '平潭县'],
    '厦门': ['思明区', '海沧区', '湖里区', '集美区', '同安区', '翔安区'],
    '莆田': ['城厢区', '涵江区', '荔城区', '秀屿区', '仙游县'],
    '三明': ['梅列区', '三元区', '明溪县', '清流县', '宁化县', '大田县', '尤溪县', '沙县', '将乐县', '泰宁县', '建宁县', '永安市'],
    '泉州': ['鲤城区', '丰泽区', '洛江区', '泉港区', '惠安县', '安溪县', '永春县', '德化县', '石狮市', '晋江市', '南安市', '金门县'],
  ...
  '江西': {
    ...
    '新余': ['渝水区', '分宜县'],
    '鹰潭': ['月湖区', '余江区', '贵溪市'],
    '赣州': ['章贡区', '南康区', '赣县区', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '龙南县', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县', '寻乌县', '石城县', '瑞金市'],
  ...
  '河南': {
    ...
    '开封': ['龙亭区', '鼓楼区', '禹王台区', '顺河回族区', '祥符区', '杞县', '通许县', '尉氏县', '兰考县'],
    ...
    '新乡': ['红旗区', '卫滨区', '凤泉区', '牧野区', '新乡县', '获嘉县', '原阳县', '延津县', '封丘县', '长垣市', '卫辉市', '辉县市'],
  ...
  '湖北': {
    ...
    '荆州': ['沙市区', '荆州区', '公安县', '监利县', '江陵县', '石首市', '洪湖市', '松滋市'],
  ...
  '湖南': {
    ...
    '株洲': ['荷塘区', '芦淞区', '石峰区', '天元区', '株洲县', '攸县', '茶陵县', '炎陵县', '醴陵市'],
    ...
    '永州': ['零陵区', '冷水滩区', '祁阳县', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县'],
  ...
  '广东': {
    ...
    '东莞': ['东城街道', '南城街道', '万江街道', '莞城街道', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇', '樟木头镇', '大朗镇', '黄江镇', '清溪镇', '塘厦镇', '凤岗镇', '大岭山镇', '长安镇', '虎门镇', '厚街镇', '沙田镇', '道滘镇', '洪梅镇', '麻涌镇', '望牛墩镇', '中堂镇', '高埗镇', '松山湖', '滨海湾新区'],
    '中山': ['石岐街道', '东区街道', '火炬开发区', '西区街道', '南区街道', '五桂山街道', '小榄镇', '黄圃镇', '民众镇', '东凤镇', '东升镇', '古镇镇', '沙溪镇', '坦洲镇', '港口镇', '三角镇', '横栏镇', '南头镇', '阜沙镇', '南朗镇', '三乡镇', '板芙镇', '大涌镇', '神湾镇'],
    '潮州': ['湘桥区', '潮安区', '饶平县'],
  ...
  '广西': {
    ...
    '桂林': ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '临桂区', '阳朔县', '灵川县', '全州县', '兴安县', '永福县', '灌阳县', '资源县', '平乐县', '荔浦市', '龙胜各族自治县', '恭城瑶族自治县'],
    ...
    '百色': ['右江区', '田阳区', '田东县', '德保县', '靖西市', '那坡县', '凌云县', '乐业县', '田林县', '西林县', '隆林各族自治县'],
  ...
  '海南': {
    ...
    '三亚': ['吉阳区', '天涯区', '海棠区', '崖州区'],
    '三沙': ['西沙区', '南沙区'],
    '儋州': ['那大镇', '和庆镇', '南丰镇', '大成镇', '雅星镇', '兰洋镇', '光村镇', '木棠镇', '海头镇', '峨蔓镇', '三都镇', '王五镇', '白马井镇', '中和镇', '排浦镇', '东成镇', '新州镇', '洋浦经济开发区', '华南热作学院'],
    '五指山': ['冲山镇', '南圣镇', '毛阳镇', '番阳镇'],
    '琼海': ['嘉积镇', '博鳌镇', '潭门镇', '长坡镇', '万泉镇', '石壁镇', '中原镇', '阳江镇', '龙江镇', '会山镇'],
    '文昌': ['文城镇', '重兴镇', '蓬莱镇', '会文镇', '东路镇', '潭牛镇', '铺前镇', '锦山镇', '翁田镇', '抱罗镇', '冯坡镇', '昌洒镇', '公坡镇', '龙楼镇', '东郊镇', '文教镇', '东阁镇'],
    '万宁': ['万城镇', '龙滚镇', '和乐镇', '后安镇', '大茂镇', '东澳镇', '礼纪镇', '长丰镇', '山根镇', '北大镇', '南桥镇', '三更罗镇'],
    '东方': ['八所镇', '三家镇', '四更镇', '新龙镇', '天安乡', '江边乡'],
    '定安': ['定城镇', '龙湖镇', '黄竹镇', '雷鸣镇', '龙门镇', '龙河镇', '岭口镇', '翰林镇'],
    '屯昌': ['屯城镇', '新兴镇', '枫木镇', '乌坡镇', '南吕镇', '南坤镇', '坡心镇', '西昌镇'],
    '澄迈': ['金江镇', '老城镇', '瑞溪镇', '永发镇', '加乐镇', '文儒镇', '中兴镇', '仁兴镇', '福山镇', '桥头镇', '大丰镇'],
    '临高': ['临城镇', '调楼镇', '新盈镇', '南宝镇', '和舍镇', '多文镇', '东英镇', '博厚镇', '皇桐镇'],
  ...
  '重庆': ['渝中区', '江北区', '南岸区', '沙坪坝区', '九龙坡区', '渝北区', '巴南区', '北碚区', '大渡口区', '万州区', '涪陵区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '綦江区', '大足区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区', '城口县', '丰都县', '垫江县', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县'],
  '四川': {
    '成都': ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '双流区', '郫都区', '新津区', '金堂县', '大邑县', '蒲江县', '简阳市', '都江堰市', '彭州市', '邛崃市', '崇州市', '高新区', '天府新区', '东部新区'],
    '自贡': ['自流井区', '贡井区', '大安区', '沿滩区', '荣县', '富顺县'],
    '攀枝花': ['东区', '西区', '仁和区', '米易县', '盐边县'],
    '泸州': ['江阳区', '纳溪区', '龙马潭区', '泸县', '合江县', '叙永县', '古蔺县'],
    '德阳': ['旌阳区', '罗江区', '中江县', '广汉市', '什邡市', '绵竹市'],
    '绵阳': ['涪城区', '游仙区', '安州区', '江油市', '三台县', '盐亭县', '梓潼县', '平武县', '北川羌族自治县'],
    '广元': ['利州区', '昭化区', '朝天区', '旺苍县', '青川县', '剑阁县', '苍溪县'],
    '遂宁': ['船山区', '安居区', '蓬溪县', '射洪市', '大英县'],
    ...
    '广安': ['广安区', '前锋区', '华蓥市', '岳池县', '武胜县', '邻水县'],
    '达州': ['通川区', '达川区', '万源市', '宣汉县', '开江县', '大竹县', '渠县'],
    ...
    '凉山': ['西昌市', '盐源县', '德昌县', '会理县', '会东县', '宁南县', '普格县', '布拖县', '金阳县', '昭觉县', '喜德县', '冕宁县', '越西县', '甘洛县', '美姑县', '雷波县', '木里藏族自治县']
  },
  '贵州': {
    ...
    '毕节': ['七星关区', '大方县', '黔西县', '金沙县', '织金县', '纳雍县', '威宁彝族回族苗族自治县', '赫章县'],
  ...
  '云南': {
    ...
    '红河': ['蒙自市', '个旧市', '开远市', '弥勒市', '建水县', '石屏县', '泸西县', '元阳县', '红河县', '金平苗族瑶族傣族自治县', '绿春县', '河口瑶族自治县'],
  ...
  '陕西': {
    ...
    '咸阳': ['秦都区', '杨陵区', '渭城区', '三原县', '泾阳县', '乾县', '礼泉县', '永寿县', '彬州市', '长武县', '旬邑县', '淳化县', '武功县', '兴平市'],
  ...
  '新疆': {
    ...
    '伊犁': ['伊宁市', '奎屯市', '霍尔果斯市', '伊宁县', '察布查尔锡伯自治县', '霍城县', '巩留县', '新源县', '尼勒克县', '特克斯县', '昭苏县'],
    '塔城': ['塔城市', '乌苏市', '额敏县', '沙湾县', '托里县', '裕民县', '和布克赛尔蒙古自治县'],
    '阿勒泰': ['阿勒泰市', '布尔津县', '富蕴县', '福海县', '哈巴河县', '青河县', '吉木乃县'],
    '石河子': ['新城街道', '向阳街道', '红山街道', '老街街道', '东城街道', '北泉镇', '石河子镇'],
    '阿拉尔': ['幸福路街道', '金银川路街道', '青松路街道'],
    '图木舒克': ['齐干却勒街道', '前海街道', '永安坝街道'],
    '五家渠': ['军垦路街道', '青湖路街道', '人民路街道'],
    '北屯': ['北屯镇'],
    '铁门关': ['铁门关镇'],
    '双河': ['双河镇'],
    '可克达拉': ['可克达拉镇']
  },
  '台湾': ['台北市', '高雄市', '台南市', '台中市', '基隆市', '新竹市', '嘉义市', '新北市', '桃园市', '新竹县', '宜兰县', '苗栗县', '彰化县', '南投县', '云林县', '嘉义县', '屏东县', '台东县', '花莲县', '澎湖县', '金门县', '连江县'],
