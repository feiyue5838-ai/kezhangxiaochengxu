...
module.exports = {
  ...
  cities: {
    ...
    '河北省': {
      ...
      '衡水市': ['桃城区', '冀州区', '枣强县', '武邑县', '深州市', '武强县', '饶阳县', '安平县', '故城县', '景县', '阜城县']
    },
    ...
    '广东省': {
      ...
      '东莞市': ['莞城街道', '南城街道', '东城街道', '万江街道', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇', '大朗镇', '麻涌镇', '中堂镇', '高埗镇', '樟木头镇', '大岭山镇', '望牛墩镇', '黄江镇', '清溪镇', '塘厦镇', '凤岗镇', '长安镇', '厚街镇', '沙田镇', '道滘镇', '洪梅镇', '虎门镇'],
      '中山市': ['石岐街道', '东区街道', '西区街道', '南区街道', '五桂山街道', '小榄镇', '黄圃镇', '民众镇', '东凤镇', '东升镇', '古镇镇', '沙溪镇', '坦洲镇', '港口镇', '三角镇', '横栏镇', '南头镇', '阜沙镇', '南朗镇', '三乡镇', '板芙镇', '大涌镇', '神湾镇'],
      '潮州市': ['湘桥区', '潮安区', '饶平县'],
    ...
    '海南省': {
      ...
      '三亚市': ['吉阳区', '天涯区', '海棠区', '崖州区'],
      '三沙市': ['西沙群岛', '南沙群岛', '中沙群岛'],
      '儋州市': ['那大镇', '和庆镇', '南丰镇', '大成镇', '雅星镇', '兰洋镇', '光村镇', '木棠镇', '海头镇', '峨蔓镇', '白马井镇', '中和镇', '排浦镇', '东成镇', '新州镇'],
      '五指山市': ['通什镇', '南圣镇', '毛阳镇', '番阳镇'],
      '琼海市': ['嘉积镇', '万泉镇', '石壁镇', '中原镇', '博鳌镇', '阳江镇', '龙江镇', '塔洋镇', '会山镇', '大路镇', '长坡镇', '潭门镇'],
      '文昌市': ['文城镇', '重兴镇', '蓬莱镇', '会文镇', '东路镇', '潭牛镇', '东阁镇', '文教镇', '东郊镇', '龙楼镇', '昌洒镇', '翁田镇', '抱罗镇', '冯坡镇', '锦山镇', '铺前镇'],
      '万宁市': ['万城镇', '龙滚镇', '和乐镇', '后安镇', '大茂镇', '东澳镇', '礼纪镇', '长丰镇', '北大镇', '三更罗镇'],
    ...
    '云南省': {
      ...
      '红河哈尼族彝族自治州': ['蒙自市', '个旧市', '开远市', '弥勒市', '建水县', '石屏县', '泸西县', '元阳县', '红河县', '金平苗族瑶族傣族自治县', '绿春县', '河口瑶族自治县'],
